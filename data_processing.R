...
bonobos <- read.csv("C:/Users/curley1/Dropbox/Work/DataVisualizationTalks/Rpackage/bonobos.csv")
caribou <- read.csv("C:/Users/curley1/Dropbox/Work/DataVisualizationTalks/Rpackage/caribou.csv")
